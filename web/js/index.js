            ...
            success: function (data) {
              if (parseInt(data.code) === 200) {
                ...
                setTimeout(function(){
                  ...
                  // $('#english').val('')
                  // $('#referrer').val('')
                  // $('#question1').val('').css('color','#999').find('span').text('0/200字').removeClass('icon-ok')
                  // $('#question2').val('').css('color','#999').find('span').text('0/200字').removeClass('icon-ok')
                  // $('#question3').val('').css('color','#999').find('span').text('0/200字').removeClass('icon-ok')
                  // $('#question4').val('').css('color','#999').find('span').text('0/200字').removeClass('icon-ok')
                  // $('#question5').val('').css('color','#999').find('span').text('0/200字').removeClass('icon-ok')
                  // $('#question6').val('').css('color','#999').find('span').text('0/200字').removeClass('icon-ok')
                },3000)
              }
            },
            error: function () {
